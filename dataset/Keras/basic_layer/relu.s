	...
	.p2align	4                               # -- Begin function tvmgen_default_fused_nn_relu
.LCPI0_0:
	.long	784                             # 0x310
	.long	784                             # 0x310
	.long	28                              # 0x1c
	.long	1                               # 0x1
	.text
	.globl	tvmgen_default_fused_nn_relu
	.p2align	4, 0x90
...
.LBB0_50:                               # %assert_fail47
	...
	jmp	.LBB0_2
.Lfunc_end0:
	.size	tvmgen_default_fused_nn_relu, .Lfunc_end0-tvmgen_default_fused_nn_relu
	.cfi_endproc
                                        # -- End function
...
.Lfunc_begin1:
	.cfi_startproc
# %bb.0:                                # %entry
	movq	$-3136, %rax                    # imm = 0xF3C0
	xorps	%xmm0, %xmm0
	.p2align	4, 0x90
.LBB1_1:                                # %if_end.15.1
                                        # =>This Inner Loop Header: Depth=1
	movaps	3136(%rsi,%rax), %xmm1
	maxps	%xmm0, %xmm1
	movaps	%xmm1, 3136(%rdi,%rax)
	movaps	3152(%rsi,%rax), %xmm1
	maxps	%xmm0, %xmm1
	movaps	%xmm1, 3152(%rdi,%rax)
	movaps	3168(%rsi,%rax), %xmm1
	maxps	%xmm0, %xmm1
	movaps	%xmm1, 3168(%rdi,%rax)
	movaps	3184(%rsi,%rax), %xmm1
	maxps	%xmm0, %xmm1
	movaps	%xmm1, 3184(%rdi,%rax)
	movaps	3200(%rsi,%rax), %xmm1
	maxps	%xmm0, %xmm1
	movaps	%xmm1, 3200(%rdi,%rax)
	movaps	3216(%rsi,%rax), %xmm1
	maxps	%xmm0, %xmm1
	movaps	%xmm1, 3216(%rdi,%rax)
	movaps	3232(%rsi,%rax), %xmm1
	maxps	%xmm0, %xmm1
	movaps	%xmm1, 3232(%rdi,%rax)
	addq	$112, %rax
	jne	.LBB1_1
# %bb.2:                                # %for_end_ax2
	retq
.Lfunc_end1:
	.size	tvmgen_default_fused_nn_relu_compute_, .Lfunc_end1-tvmgen_default_fused_nn_relu_compute_
	.cfi_endproc
                                        # -- End function
...
.L.str.16:
	.asciz	"Assert fail: (28 == int32(arg1.shape[2])), Argument arg1.shape[2] has an unsatisfied constraint: (28 == int32(arg1.shape[2]))"
	.size	.L.str.16, 126

	.type	.L.str.17,@object               # @.str.17
.L.str.17:
	.asciz	"Assert fail: (28 == int32(arg1.shape[3])), Argument arg1.shape[3] has an unsatisfied constraint: (28 == int32(arg1.shape[3]))"
	.size	.L.str.17, 126
...
.L.str.21:
	...
	.weak	__tvm_main__
__tvm_main__:
	.asciz	"tvmgen_default_fused_nn_relu"
	.size	__tvm_main__, 29
